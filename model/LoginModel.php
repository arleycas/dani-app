...
require_once 'MainModel.php';
  ...
  class LoginModel extends MainModel {
    ...
    protected static function iniciarSesionModel($arrData) {
      $sql = MainModel::connectDB()->prepare("SELECT PKUSU_ID, USU_NOMBRE FROM indegwgj_db_daniapp.tbl_usuario WHERE USU_NOMBRE = :m_nombre AND USU_CONTRASENA = :m_contrasena");
